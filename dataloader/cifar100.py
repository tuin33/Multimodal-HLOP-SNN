...
def get(data_dir='./data/',seed=0):
    ...
    if not os.path.isdir(file_dir):
        ...
        mean = [0.5071, 0.4867, 0.4408]  # CIFAR-100 数据集的均值
        std = [0.2675, 0.2565, 0.2761]   # CIFAR-100 数据集的标准差

        # 定义训练集和测试集的 transform
        ...
        # 加载 CIFAR-100 数据集
        dat = {}
        dat['train'] = datasets.CIFAR100(data_dir, train=True, download=True, transform=train_transform)
        dat['test'] = datasets.CIFAR100(data_dir, train=False, download=True, transform=test_transform)        
